...
const ReportsEnhanced = () => {
    ...
    return `
      ...
      <body>
        <div class="document-header">
          <div class="org-name">${escapeHtml(orgSettings?.organization_name) || 'Your Organization'}</div>
          <div class="doc-title-row">
            <span class="doc-type">${escapeHtml(reportTitle)}</span>
            <span class="doc-date-range">${escapeHtml(dateRangeText)}</span>
          </div>
        </div>
        ...
        <div class="info-section">
          <div class="info-row">
            ...
            <span class="info-value">${escapeHtml(profile?.full_name) || 'User'}</span>
          </div>
          <div class="info-row">
        ...
        <div class="document-footer">
          ...
          <p>${escapeHtml(orgSettings?.organization_name) || 'Your Organization'} - Reports & Analytics</p>
        </div>
      </body>
      </html>
    `
  ...
  const handleExportPDF = async () => {
    ...
    try {
      // Lazy load jsPDF (saves ~100KB from initial bundle)
