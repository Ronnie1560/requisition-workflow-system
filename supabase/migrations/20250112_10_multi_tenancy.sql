-- =====================================================
-- PCM Requisition System - Multi-Tenancy Migration
...
-- =====================================================
-- STEP 3: Add org_id to all existing tables
-- =====================================================
...
-- Add org_id to approval_workflows table
...
-- Add org_id to fiscal_year_settings table
...
-- Add org_id to uom_types table (if it exists)
DO $$
BEGIN
...
-- =====================================================
-- STEP 5: Helper function to get current user's org
-- =====================================================
...
-- Helper: Drop existing policies and recreate with org isolation
-- We'll update the most critical tables
...
CREATE POLICY "Admins can manage org workflows"
...
BEGIN
  ...
  -- Create default fiscal year settings
